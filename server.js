...
app.get('/adCurso', (req, res) => {
    res.render('ad_curso', {
        style:'ad_curso_style'
    });
});

app.get('/anotacoes', (req, res) => {
    res.render('anotacoes', {
        style:'anotacoesStyle'
    });
});

app.get('/cursos', (req, res) => {
    res.render('profCursos', {
        style:'profCursos_style'
    });
});
...
app.get('/teste/:1', courseController.funcTeste);
